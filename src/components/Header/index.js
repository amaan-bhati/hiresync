  ...
  return (
    <header className="w-full p-4  px-5 sm:px-10 flex items-center justify-between">
        ...
        >
            ...
            <Link href="https://contact.amaanbhati.tech" className="mx-2">Contact</Link>
        ...
        <div className=" hidden sm:flex items-center">
            ...
            <a href={siteMetadata.siteLogo} rel="noopener noreferrer" className="inline-block w-6 h-6 mr-4" aria-label="Check my profile on Dribbble" target="_blank"><DribbbleIcon className="hover:scale-125 transition-all ease duration-200" /></a>
        </div>
    </header>
  )
}
